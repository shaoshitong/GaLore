...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="./datasets/GLUE/sst2/train.csv", help="A csv or a json file containing the training data."
    )
    parser.add_argument(
        "--validation_file", type=str, default="./datasets/GLUE/sst2/dev.csv", help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--max_length",
        type=int,
...
def main():
    ...
    if args.task_name is not None:
        metric = evaluate.load("./evaluate-main/metrics/glue", args.task_name)    #TODO
    else:
