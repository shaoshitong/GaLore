...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="/home/zj23/data/GaLore-master/GaLore-master/datasets/GLUE/MRPC/msr_paraphrase_train.csv", help="A csv or a json file containing the training data."
    )
    parser.add_argument(
        "--validation_file", type=str, default="/home/zj23/data/GaLore-master/GaLore-master/datasets/GLUE/MRPC/msr_paraphrase_test.csv", help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--max_length",
        type=int,
...
def main():
    ...
    if args.task_name is not None:
        ...
        is_regression = raw_datasets["train"].features["Quality"].dtype in ["float32", "float64"]
        if is_regression:
            num_labels = 1
        else:
            # A useful fast method:
            # https://huggingface.co/docs/datasets/package_reference/main_classes.html#datasets.Dataset.unique
            label_list = raw_datasets["train"].unique("Quality")
    ...
    def preprocess_function(examples):
        ...
        if "Quality" in examples:    #TODO
            if label_to_id is not None:
                # Map labels to IDs (not necessary for GLUE tasks)
                result["labels"] = [label_to_id[l] for l in examples["label"]]
            else:
                # In all cases, rename the column to labels because the model will expect that.
                result["labels"] = examples["Quality"]  #TODO
        return result
