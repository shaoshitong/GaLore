...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="/home/zj23/data/GaLore-master/GaLore-master/datasets/GLUE/sst2/train.csv",
        help="A csv or a json file containing the training data."
    )
    parser.add_argument(
        "--validation_file", type=str, default="/home/zj23/data/GaLore-master/GaLore-master/datasets/GLUE/sst2/dev.csv",
...
def main():
    ...
    peft_config = LoraConfig(
        ...
        target_modules=target_modules_list  # 之前定义的目标模块列表
    )
    ...
    if args.task_name is not None:
        metric = evaluate.load("/home/zj23/data/GaLore-master/GaLore-master/evaluate-main/metrics/glue",
                               args.task_name)  # TODO
    else:
