...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="/home/zj23/data/GaLore-master/GaLore-master/datasets/GLUE/sst2/train.csv", help="A csv or a json file containing the training data."
    )
    parser.add_argument(
        "--validation_file", type=str, default="/home/zj23/data/GaLore-master/GaLore-master/datasets/GLUE/sst2/dev.csv", help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--max_length",
        type=int,
...
def main():
    ...
    if args.task_name is not None:
        metric = evaluate.load("/home/zj23/data/GaLore-master/GaLore-master/evaluate-main/metrics/glue", args.task_name)    #TODO
    else:
    ...
    if args.output_dir is not None:
        ...
        max_accuracy = max(result["metric"]["accuracy"] for result in all_results)
        max_epoch = next(result["epoch"] for result in all_results if result["metric"]["accuracy"] == max_accuracy)
