...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="/home/data02/zj23/GaLore-master/datasets/GLUE/cola/train.csv",
        help="A csv or a json file containing the training data."
    )
    parser.add_argument(
        "--validation_file", type=str, default="/home/data02/zj23/GaLore-master/datasets/GLUE/sst2/dev.csv",
...
def main():
    ...
    if args.task_name is not None:
        metric = evaluate.load("/home/data02/zj23/GaLore-master/evaluate-main/metrics/glue",
                               "sst2")  # TODO
    else:
